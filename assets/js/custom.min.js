...
!function(e) {
    ...
    e(document).ready(function() {
        ...
        e(".show-menu-btn").on("click", function() {
            return e(this).toggleClass("open"),
            e(".overlay-menu").toggleClass("active"),
            e("body").toggleClass("menu-opened"),
            !1
        }),
        e(window).keydown(function(t) {
            e(".overlay-menu").hasClass("active") && 27 === t.which && (e(".show-menu-btn").removeClass("open"),
            e(".overlay-menu").removeClass("active"),
            e("body").removeClass("menu-opened"))
        });
        var o = e("#filters")
          , r = e(".row-portfolio");
        e("a", o).on("click", function() {
            var t = e(this).attr("data-filter");
            return e(".current", o).removeClass("current"),
        ...
        e(".progress-bar").each(function() {
            e(this).appear(function() {
                ...
                e(this).parent(".progress").prev(".progress-title").find(".p-coutn").countTo({
                    from: 0,
                    to: t,
                    speed: 900,
                    refreshInterval: 30
        ...
        e(".smoothscroll").on("click", function(t) {
            ...
            e("html, body").stop().animate({
                scrollTop: r.offset().top - header.height()
            }, 600, "swing"),
            t.preventDefault()
        }),
